...
create TABLE IF NOT EXISTS ecomm.product (id uuid NOT NULL DEFAULT gen_random_uuid(),
...
create TABLE IF NOT EXISTS ecomm.tag (id uuid NOT NULL DEFAULT gen_random_uuid(),
    name varchar(20),
    PRIMARY KEY(id)
    );

create TABLE IF NOT EXISTS ecomm.product_tag (product_id uuid NOT NULL, tag_id uuid NOT NULL, FOREIGN KEY (product_id)
...
create TABLE IF NOT EXISTS ecomm."user" ( id uuid NOT NULL DEFAULT gen_random_uuid(),
    username varchar(16),
    password varchar(40),
...
create TABLE IF NOT EXISTS ecomm.address ( id uuid NOT NULL DEFAULT gen_random_uuid(),
    number varchar(24),
...
create TABLE IF NOT EXISTS ecomm.user_address ( user_id uuid NOT NULL, address_id uuid NOT NULL, FOREIGN KEY (user_id)
    REFERENCES ecomm."user"(id),
    FOREIGN KEY(address_id)
    REFERENCES ecomm.address(id)
    );

create TABLE IF NOT EXISTS ecomm.payment ( id uuid NOT NULL DEFAULT gen_random_uuid(),
    authorized boolean,
    message varchar(64),
    PRIMARY KEY(id)
    );

create TABLE IF NOT EXISTS ecomm.card ( id uuid NOT NULL DEFAULT gen_random_uuid(),
    number varchar(16),
...
create TABLE IF NOT EXISTS ecomm.shipment (id uuid NOT NULL DEFAULT gen_random_uuid(),
    est_delivery_date timestamp,
    carrier varchar(24),
    PRIMARY KEY(id)
    );

create TABLE IF NOT EXISTS ecomm.orders (id uuid NOT NULL DEFAULT gen_random_uuid(),
...
create TABLE IF NOT EXISTS ecomm.item (id uuid NOT NULL DEFAULT gen_random_uuid(),
...
create TABLE IF NOT EXISTS ecomm."authorization" (id uuid NOT NULL DEFAULT gen_random_uuid(),
    order_id uuid NOT NULL,
    authorized boolean,
    time timestamp,
    message varchar(16),
...
create TABLE IF NOT EXISTS ecomm.cart (id uuid NOT NULL DEFAULT gen_random_uuid(),
